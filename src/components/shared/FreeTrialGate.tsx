      ...
      <div className="min-h-screen flex items-center justify-center p-4">
        <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-2xl p-8 max-w-md w-full shadow-2xl text-center`}>
          ...
          <div className="flex flex-col gap-3">
            ...
            <button
              onClick={onBack}
              className={`w-full px-6 py-3 rounded-xl font-medium ${darkMode ? 'bg-gray-700 hover:bg-gray-600 text-white' : 'bg-gray-100 hover:bg-gray-200 text-gray-800'} transition-colors`}
            >
              Retour
            </button>
          </div>
